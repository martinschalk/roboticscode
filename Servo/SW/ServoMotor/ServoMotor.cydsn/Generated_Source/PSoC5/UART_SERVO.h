...
#define UART_SERVO_TXBUFFERSIZE                   (32u)
#define UART_SERVO_RXBUFFERSIZE                   (32u)
...
#define UART_SERVO_BIT_CENTER                         (UART_SERVO_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 UART_SERVO_initVar;
    ...
    extern volatile uint8 UART_SERVO_txBuffer[UART_SERVO_TXBUFFERSIZE];
    ...
    extern volatile uint8 UART_SERVO_rxBuffer[UART_SERVO_RXBUFFERSIZE];
...
#if (UART_SERVO_RXHW_ADDRESS_ENABLED)
    #define UART_SERVO_RXADDRESSMODE      (0u)
    #define UART_SERVO_RXHWADDRESS1       (0u)
    #define UART_SERVO_RXHWADDRESS2       (0u)
...
#define UART_SERVO_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((0 << UART_SERVO_TX_STS_COMPLETE_SHIFT) \
                                        | (1 << UART_SERVO_TX_STS_FIFO_EMPTY_SHIFT) \
