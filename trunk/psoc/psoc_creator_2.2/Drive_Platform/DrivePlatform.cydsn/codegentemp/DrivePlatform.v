...
// Timer_v2_50(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=AsyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=999999999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=nrstSts, RunMode=0, SiliconRevision=1, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT32, CY_COMPONENT_NAME=Timer_v2_50, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=TIMER, CY_INSTANCE_SHORT_NAME=TIMER, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=TIMER, )
...
module UART_v2_30_2 (
	...
	cy_clock_v1_0
		#(.id("d4b03476-19f9-47de-bd50-5bc6e81cb5e4/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__DEBUG_LED_1_net;
	wire [0:0] tmpFB_0__DEBUG_LED_1_net;
	wire [0:0] tmpIO_0__DEBUG_LED_1_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_LED_1_net;
	electrical [0:0] tmpSIOVREF__DEBUG_LED_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		DEBUG_LED_1
		 (.oe(tmpOE__DEBUG_LED_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUG_LED_1_net[0:0]}),
		  .io({tmpIO_0__DEBUG_LED_1_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_LED_1_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_LED_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_LED_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam TIMER.SiliconRevision = "1";
