...
#ifdef UART_TEST_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG
    #define UART_TEST_CONTROL_REG_REMOVED            (0u)
#else
    #define UART_TEST_CONTROL_REG_REMOVED            (1u)
#endif /* End UART_TEST_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG */
...
***************************************/
    ...
    #define UART_TEST_CONTROL_REG \
                            (* (reg8 *) UART_TEST_BUART_sCR_AsyncCtl_CtrlReg__CONTROL_REG )
