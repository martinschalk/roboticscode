...
#define BS_UDB_0_5_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000430u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480004C4u)

/* IOPORT_0 Address: CYDEV_PRTDSI_PRT0_BASE Size (bytes): 7 */
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x480004CCu)

/* IOPORT_4 Address: CYDEV_PRTDSI_PRT4_BASE Size (bytes): 7 */
#define BS_IOPORT_4_VAL ((const uint8 CYFAR *)0x480004D4u)
